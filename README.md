...
## Usage and flags:
Run the following command in the terminal in the same directory as the executable(note: this program was built for windows, if you are on linux or :barf:mac build it yourself. its not that hard)
